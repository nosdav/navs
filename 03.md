...
`draft` `mandatory` `author:kieran` `author:melvincarvalho`
...
NAV-03 is based on the original form of [NIP-98](https://github.com/nostr-protocol/nips/blob/de1aec64d21415c2f96fce6694de294c282ce128/98.md)
